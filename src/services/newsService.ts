    ...
    try {
      if (this.baseUrl && this.apiKey) {
        const response = await fetch(
          `${this.baseUrl}/news/search?q=${encodeURIComponent(
            keyword
          )}&limit=${limit}`,
          {
            headers: {
    ...
    return [
      {
        ...
        summary:
          "中国人民银行决定于2024年1月15日下调金融机构存款准备金率0.25个百分点",
      ...
      },
      {
        ...
        summary:
          "美联储理事鲍威尔在最新讲话中表示，考虑到通胀数据的改善，可能会暂停进一步加息",
      ...
      },
      {
        ...
        summary:
          "2024年1月新能源汽车销量同比增长35%，产业链上下游企业业绩预期向好",
      ...
      },
      {
        ...
        summary:
          "受地缘政治因素影响，国际原油价格今日上涨2%，能源类股票普遍上涨",
